...
<head>
  ...
  <!-- table -->
   <link rel="stylesheet" href="adminpanel/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Courses</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Course Detail</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Batch</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Activity</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Comments</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>likes</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<!-- DataTables -->
<script src="adminpanel/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="adminpanel/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- page script -->
<script>
  $(function () {
    $('#example1').DataTable()
