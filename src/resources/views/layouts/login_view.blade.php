      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ url('adminpanel/dist/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ url('adminpanel/dist/img/user3-128x128.jpg') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ url('adminpanel/dist/img/user4-128x128.jpg') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ url('adminpanel/dist/img/user2-160x160.jpg') }}" class="user-image" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{url('/courses')}}"><i class="fa fa-circle-o text-yellow"></i> <span>Courses</span></a></li>
        <li><a href="{{url('/course_details')}}"><i class="fa fa-circle-o text-yellow"></i> <span>Course Details</span></a></li>
        <li><a href="{{url('/batches')}}"><i class="fa fa-circle-o text-aqua"></i> <span>Batch</span></a></li>
        <li><a href="{{url('/activities')}}"><i class="fa fa-circle-o text-aqua"></i> <span>Activity</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
