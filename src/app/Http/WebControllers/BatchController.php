...
use App\Http\ApiControllers\BatchController as BatchApiController;

class BatchController extends Controller
{
    public $batchApi;
    public function __construct(BatchApiController $batchApi)
    {
    ...
    public function index(Request $request)
    {
      ...
      $response = $this->batchApi->index($request);
      $response = $response->getData()->data;
      return view('Batch.list', compact('response'));
    }
