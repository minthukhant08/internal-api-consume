...
use App\Http\ApiControllers\CourseDetailController as CourseDeatilApiController;

class CourseDetailController extends Controller
{
    public $courseDeatilApi;
    public function __construct(CourseApiController $courseDeatilApi)
    {
      $this->courseDeatilApi = $courseDeatilApi;
    }
    /**
    ...
    public function index(Request $request)
    {
      ...
      $response = $this->courseDeatilApi->index($request);
